...
- Debian: Update Dovecot to latest Chatmail build with security backports
...
- Debian: Lego binary fetching and installation refactoring for resiliency if file corruption happens
- Lego: Update to v5 and automatically migrate the account data from v4 to v5
